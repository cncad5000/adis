...
# 全局变量
INSTALL_DIR = Path.home() / ".adis"  # 用户主目录下的隐藏文件夹，避免root权限
CONFIG_FILE = INSTALL_DIR / "config.json"
SB_PID_FILE = INSTALL_DIR / "sbpid.log"
andt_PID_FILE = INSTALL_DIR / "sbandtpid.log"
LIST_FILE = INSTALL_DIR / "list.txt"
LOG_FILE = INSTALL_DIR / "andt.log"
...
def print_info():
    ...
    print("\033[36m│                \033[33m✨ AndtIS Python3 一键脚本 ✨               \033[36m│\033[0m")
    print("\033[36m├───────────────────────────────────────────────────────────────┤\033[0m")
    print("\033[36m│ \033[32m作者: 蚂蚁                                                  \033[36m│\033[0m")
    print("\033[36m│ \033[32mGithub: https://github.com/zhumengkang/                    \033[36m│\033[0m")
    print("\033[36m│ \033[32mYouTube: https://www.youtube.com/@蚂蚁的V2Ray与Clash         \033[36m│\033[0m")
...
def print_usage():
    ...
    print("  \033[36mpython3 adis.py\033[0m              - 安装并启动服务")
    print("  \033[36mpython3 adis.py install\033[0m      - 安装服务")
    print("  \033[36mpython3 adis.py status\033[0m       - 查看服务状态和节点信息")
    print("  \033[36mpython3 adis.py cat\033[0m          - 查看单行节点列表")
    print("  \033[36mpython3 adis.py update\033[0m       - 更新脚本")
    print("  \033[36mpython3 adis.py del\033[0m          - 卸载服务")
    print("  \033[36mpython3 adis.py testapi\033[0m      - 测试API服务器连接")
    print()
...
def generate_links(domain, port_vm_ws, uuid_str):
    ...
    # 443端口 - 104.16.0.0
    config1 = {
        "ps": f"vmess-ws-tls-andt-{hostname}-443",
        "add": "104.16.0.0",
        "port": "443",
        "id": uuid_str,
        "aid": "0",
    ...
    # 8443端口 - 104.17.0.0
    config2 = {
        "ps": f"vmess-ws-tls-andt-{hostname}-8443",
        "add": "104.17.0.0",
        "port": "8443",
        "id": uuid_str,
        "aid": "0",
    ...
    # 2053端口 - 104.18.0.0
    config3 = {
        "ps": f"vmess-ws-tls-andt-{hostname}-2053",
        "add": "104.18.0.0",
        "port": "2053",
        "id": uuid_str,
        "aid": "0",
    ...
    # 2083端口 - 104.19.0.0
    config4 = {
        "ps": f"vmess-ws-tls-andt-{hostname}-2083",
        "add": "104.19.0.0",
        "port": "2083",
        "id": uuid_str,
        "aid": "0",
    ...
    # 2087端口 - 104.20.0.0
    config5 = {
        "ps": f"vmess-ws-tls-andt-{hostname}-2087",
        "add": "104.20.0.0",
        "port": "2087",
        "id": uuid_str,
        "aid": "0",
    ...
    # 80端口 - 104.21.0.0
    config6 = {
        "ps": f"vmess-ws-andt-{hostname}-80",
        "add": "104.21.0.0",
        "port": "80",
        "id": uuid_str,
        "aid": "0",
    ...
    # 8080端口 - 104.22.0.0
    config7 = {
        "ps": f"vmess-ws-andt-{hostname}-8080",
        "add": "104.22.0.0",
        "port": "8080",
        "id": uuid_str,
        "aid": "0",
    ...
    # 8880端口 - 104.24.0.0
    config8 = {
        "ps": f"vmess-ws-andt-{hostname}-8880",
        "add": "104.24.0.0",
        "port": "8880",
        "id": uuid_str,
        "aid": "0",
    ...
    with open(str(LIST_FILE), 'w') as f:
        ...
        f.write("\033[36m│                    \033[33m✨ AndtIS 节点信息 ✨                   \033[36m│\033[0m\n")
        f.write("\033[36m├───────────────────────────────────────────────────────────────┤\033[0m\n")
        ...
        f.write("\033[36m│ \033[32m查看节点信息: \033[0mpython3 adis.py status\n")
        f.write("\033[36m│ \033[32m查看所有节点(一行一个): \033[0mpython3 adis.py cat\n")
        f.write("\033[36m│ \033[32m升级脚本: \033[0mpython3 adis.py update\n")
        f.write("\033[36m│ \033[32m卸载脚本: \033[0mpython3 adis.py del\n")
        f.write("\033[36m╰───────────────────────────────────────────────────────────────╯\033[0m\n")
    ...
    with open(str(LIST_FILE) + ".txt", 'w') as f:
        ...
        f.write("---------------------------------------------------------\n")
        f.write("单行节点文件路径: ~/.adis/allnodes.txt\n")
        f.write("使用方法:\n")
        f.write("查看节点信息: python3 adis.py status\n")
        f.write("查看所有节点(一行一个): python3 adis.py cat\n")
        f.write("升级脚本: python3 adis.py update\n")
        f.write("卸载脚本: python3 adis.py del\n")
        f.write("---------------------------------------------------------\n")
    ...
    with open(str(readme_file), 'w') as f:
        ...
        f.write("## 单行格式节点文件\n\n")
        f.write("如果您需要每行一个节点的格式，可以查看文件: `~/.adis/allnodes.txt`\n\n")
        f.write("```bash\ncat ~/.adis/allnodes.txt\n```\n\n")
        ...
        f.write("## 注意事项\n\n")
        f.write("- 该脚本由蚂蚁开发，更多信息请访问 [GitHub项目](https://github.com/zhumengkang/)\n")
    ...
    # 打印节点信息
    print("\033[36m╭───────────────────────────────────────────────────────────────╮\033[0m")
    print("\033[36m│                \033[33m✨ AndtIS 安装成功! ✨                    \033[36m│\033[0m")
    print("\033[36m├───────────────────────────────────────────────────────────────┤\033[0m")
    ...
    print("\033[36m├───────────────────────────────────────────────────────────────┤\033[0m")
    print("\033[36m│ \033[33m所有节点列表 (一行一个版本保存在: ~/.adis/allnodes.txt):\033[0m")
    ...
    print("\033[36m│ \033[32m使用 \033[33mpython3 adis.py status\033[32m 查看节点信息\033[0m")
    print("\033[36m│ \033[32m使用 \033[33mpython3 adis.py del\033[32m 删除节点\033[0m")
    print("\033[36m╰───────────────────────────────────────────────────────────────╯\033[0m")
...
def setup_autostart():
    try:
        ...
        filtered_lines = []
        for line in lines:
            if ".adis/start_sb.sh" not in line and ".adis/start_cf.sh" not in line:
...
def uninstall():
    ...
    try:
        ...
        if os.path.exists(str(andt_PID_FILE)):
            with open(str(andt_PID_FILE), 'r') as f:
                pid = f.read().strip()
                if pid:
                    os.system("kill {} 2>/dev/null || true".format(pid))
...
def upgrade():
    try:
        script_content = http_get("https://raw.githubusercontent.com/yonggekkk/AndtIS/main/AndtIS.py")
        if script_content:
...
def check_status():
    try:
        ...
        if sing_box_running and cloudflared_running and os.path.exists(str(LIST_FILE)):
            print("\033[36m╭───────────────────────────────────────────────────────────────╮\033[0m")
            print("\033[36m│                \033[33m✨ AndtIS 运行状态 ✨                    \033[36m│\033[0m")
            print("\033[36m├───────────────────────────────────────────────────────────────┤\033[0m")
            print("\033[36m│ \033[32m服务状态: \033[33m正在运行\033[0m")
            
            andt_name_file = INSTALL_DIR / "sbandtym.log"
            if os.path.exists(str(andt_name_file)):
                with open(str(andt_name_file), 'r') as f:
                    andtname = f.read().strip()
                print(f"\033[36m│ \033[32mandt固定域名: \033[0m{andtname}")
                
                token_file = INSTALL_DIR / "sbandttoken.log"
                if os.path.exists(str(token_file)):
                    with open(str(token_file), 'r') as f:
                        print(f"\033[36m│ \033[32mandt固定域名Token: \033[0m{f.read().strip()}")
            else:
                # 读取临时域名
                if os.path.exists(str(LOG_FILE)):
                    ...
                    if domain_match:
                        andtdomain = domain_match.group(1)
                        print(f"\033[36m│ \033[32mandt临时域名: \033[0m{andtdomain}")
                    else:
                        print("\033[36m│ \033[31mandt临时域名未生成，请重新安装\033[0m")
            ...
            print("\033[36m│                \033[33m✨ AndtIS 运行状态 ✨                    \033[36m│\033[0m")
            print("\033[36m├───────────────────────────────────────────────────────────────┤\033[0m")
            print("\033[36m│ \033[31mAndtIS脚本未运行\033[0m")
            print("\033[36m│ \033[32m运行 \033[33mpython3 adis.py\033[32m 开始安装\033[0m")
            print("\033[36m╰───────────────────────────────────────────────────────────────╯\033[0m")
            return False
        else:
            print("\033[36m╭───────────────────────────────────────────────────────────────╮\033[0m")
            print("\033[36m│                \033[33m✨ AndtIS 运行状态 ✨                    \033[36m│\033[0m")
            print("\033[36m├───────────────────────────────────────────────────────────────┤\033[0m")
            print("\033[36m│ \033[31mAndtIS脚本状态异常\033[0m")
            print("\033[36m│ \033[32m建议卸载后重新安装: \033[33mpython3 adis.py del\033[0m")
            print("\033[36m╰───────────────────────────────────────────────────────────────╯\033[0m")
            return False
    except Exception as e:
        print("\033[36m╭───────────────────────────────────────────────────────────────╮\033[0m")
...
''')
    ...
    with open(str(cf_start_script), 'w') as f:
        f.write(f'''#!/bin/bash
cd {INSTALL_DIR}
./cloudflared tunnel --url http://localhost:{port_vm_ws}/$(cat config.json | grep -o '"uuid_str":"[^"]*"' | cut -d'"' -f4)-vm?ed=2048 --edge-ip-version auto --no-autoupdate --protocol http2 > andt.log 2>&1 & echo $! > sbandtpid.log
''')
...
def main():
    ...
    if len(sys.argv) > 1:
        ...
        if check_status():
            print("\033[36m╭───────────────────────────────────────────────────────────────╮\033[0m")
            print("\033[36m│                \033[33m✨ AndtIS 已在运行 ✨                    \033[36m│\033[0m")
            print("\033[36m├───────────────────────────────────────────────────────────────┤\033[0m")
            print("\033[36m│ \033[32mAndtIS脚本已在运行，如需重新安装请先卸载\033[0m")
            print("\033[36m│ \033[32m卸载命令: \033[33mpython3 adis.py del\033[0m")
            print("\033[36m╰───────────────────────────────────────────────────────────────╯\033[0m")
            sys.exit(0)
        else:
            print("\033[36m╭───────────────────────────────────────────────────────────────╮\033[0m")
            print("\033[36m│               \033[33m✨ 开始安装 AndtIS ✨                    \033[36m│\033[0m")
            print("\033[36m╰───────────────────────────────────────────────────────────────╯\033[0m")
            install()
